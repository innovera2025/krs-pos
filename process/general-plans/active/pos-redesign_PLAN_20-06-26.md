...
| `screen-design-spec-hub` | Design Spec hub (เอกสารดีไซน์) | docs | 🔴 no | 🔴 no | build-new-ui | ✅ (6c) |
...
| `action-docs-tab` | Switch design-spec tab (setDocsTab) | docs | 🔴 no | 🔴 no | build-new-ui | ✅ (6c) |
...
| `display-docs-overview-panel` | Design Spec — Overview panel | docs | 🔴 no | 🔴 no | build-new-ui | ✅ (6c) |
| `display-docs-ia-matrix` | Design Spec — IA / Sitemap permission matrix | docs | 🔴 no | 🔴 no | build-new-ui | ✅ (6c) |
| `display-docs-flows-panel` | Design Spec — Key user flows panel | docs | 🔴 no | 🔴 no | build-new-ui | ✅ (6c) |
| `display-docs-screen-list` | Design Spec — Screen list (MVP) panel | docs | 🔴 no | 🔴 no | build-new-ui | ✅ (6c) |
| `display-docs-component-inventory` | Design Spec — Component inventory panel | docs | 🔴 no | 🔴 no | build-new-ui | ✅ (6c) |
| `display-docs-tokens-panel` | Design Spec — Design tokens panel | docs | 🔴 no | 🔴 no | build-new-ui | ✅ (6c) |
| `display-docs-copy-panel` | Design Spec — UX copy (TH/EN) panel | docs | 🔴 no | 🔴 no | build-new-ui | ✅ (6c) |
| `display-docs-rules-panel` | Design Spec — Accounting UX rules panel | docs | 🔴 no | 🔴 no | build-new-ui | ✅ (6c) |
| `display-docs-visual-directions` | Design Spec — 2 Visual directions panel | docs | 🔴 no | 🔴 no | build-new-ui | ✅ (6c) |
| `display-docs-impl-notes` | Design Spec — Implementation notes panel | docs | 🔴 no | 🔴 no | build-new-ui | ✅ (6c) |
