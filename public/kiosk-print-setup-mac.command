#!/bin/bash
#  *** IN-PRODUCT COPY — served at /kiosk-print-setup-mac.command by Next.js static asset. Keep in sync with deploy/kiosk-print-setup-mac.command (the canonical source). ***
# ============================================================================
